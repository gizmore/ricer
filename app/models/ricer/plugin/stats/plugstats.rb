module Ricer::Plugin::Stats
  class Plugstats < Ricer::Plug::Trigger
    
    def self.upgrade_1; TriggerCounter.upgrade_1; end
    def ricer_on_trigger; TriggerCounter.count(@irc_message.plugin_id, user.id); end
